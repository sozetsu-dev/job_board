			...
			<ul>
				...
				<li class="dropdown">
					...
					<div class="dropdown-content">
						<a href="register_ent.php">Inscription Entreprise</a>
						<a href="register.php">Inscription Particulier</a>
					</div>
				</li>
				<li class="dropdown">
					<a href="javascript:void(0)" class="dropbtn">Contact</a>
					<div class="dropdown-content">
						<a href="contact_ent.php">Contact Entreprise</a>
						<a href="contact.php">Contact Particulier</a>
					</div>
				</li>
				<li class="dropdown">
					<a href="javascript:void(0)" class="dropbtn">Membre +</a>
					<div class="dropdown-content">
						<a href="annonce_ent.php">Poster une Annonce</a>
						<a href="profil.php">Profil</a>
					</div>
				</li>
				<li class="tooltip" style="float:right"><a href="deconnexion.php">Déconnexion</a></li>
			</ul>
		</nav>
